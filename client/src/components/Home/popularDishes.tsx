          ...
          <div className="container">
            <div className="popular-dishes-wrapper style2 section-padding bg-white ">
              <div className="shape1 float-bob-x d-none d-xxl-block">
                <img src={popularDishesShape1_1} alt="shape" />
              </div>
              <div className="shape2 float-bob-x d-none d-xxl-block">
                <img src={popularDishesShape1_2} alt="shape" />
              </div>
              <div className="container">
                <div className="title-area">
                  <div
                    className="sub-title text-center wow fadeInUp flex justify-center"
                    data-wow-delay="0.5s"
                  >
                ...
                <div className="dishes-card-wrap style1 mb-60">
                  ...
                  >
                    <div className="dishes-thumb flex !justify-center !items-center">
                      ...
                      <div className="circle-shape flex !justify-center !items-center">
                        <img className="cir36" src={circleShape} alt="shape" />
                      </div>
                    </div>
                    <div className="dishes-content">
                      ...
                      <h6>$24.00</h6>
                      <a href="menu.html" className="theme-btn style6">
                        {" "}
                        Order Now{" "}
