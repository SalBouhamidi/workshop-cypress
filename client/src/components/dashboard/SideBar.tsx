...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="dark">
      <nav
        className={`sidebar fixed inset-y-0 z-50 h-full w-[260px] border-r border-gray-200 bg-white shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300 dark:border-gray-800 dark:bg-gray-900 ${
        ...
        <div className="h-full">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="hover:bg-gray-100 dark:hover:bg-gray-800 rtl:rotate-180"
          ...
          <ScrollArea className="h-[calc(100vh-80px)] px-4 py-3">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="dashboard">
                <AccordionTrigger className="flex w-full items-center py-2 text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100">
                  <svg
                  ...
                  <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-gray-300 dark:group-hover:text-gray-100">
                    {t("dashboard")}
                  </span>
                </AccordionTrigger>
                <AccordionContent>
                  <ul className="mt-1 space-y-1 pl-6 text-sm text-gray-500 dark:text-gray-400">
                    <li>
                      <NavLink
                        to="/"
                        className="block py-1 hover:text-gray-800 dark:hover:text-gray-200"
                      >
                        {t("sales")}
                      </NavLink>
                    </li>
...
const Sidebar : React.FC = () => {
    ...
    return (
        <div className='dark'>
            <nav className={`sidebar fixed inset-y-0 z-50 h-full w-[260px] border-r border-gray-200 bg-white shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300 dark:border-gray-800 dark:bg-gray-900 ${isSidebarOpen ? 'left-0' : '-left-[260px]'}`}>
                <div className="h-full">
                    <div className="flex items-center justify-between px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            <span className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white lg:inline">{t('AlloMedia')}</span>
                        </NavLink>
                        <Button
                            variant="ghost"
                            size="icon"
                    ...
                    <ScrollArea className="h-[calc(100vh-80px)] px-4 py-3">
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="dashboard">
                                <AccordionTrigger className="flex w-full items-center py-2 text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100">
                                    <svg className="shrink-0 mr-2" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            opacity="0.5"
                                            d="M2 12.2039C2 9.91549 2 8.77128 2.5192 7.82274C3.0384 6.87421 3.98695 6.28551 5.88403 5.10813L7.88403 3.86687C9.88939 2.62229 10.8921 2 12 2C13.1079 2 14.1106 2.62229 16.116 3.86687L18.116 5.10812C20.0131 6.28551 20.9616 6.87421 21.4808 7.82274C22 8.77128 22 9.91549 22 12.2039V13.725C22 17.6258 22 19.5763 20.8284 20.7881C19.6569 22 17.7712 22 14 22H10C6.22876 22 4.34315 22 3.17157 20.7881C2 19.5763 2 17.6258 2 13.725V12.2039Z"
                                            fill="currentColor"
                                    ...
                                    <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-gray-300 dark:group-hover:text-gray-100">{t('dashboard')}</span>
                                </AccordionTrigger>
                                <AccordionContent>
                                    <ul className="mt-1 space-y-1 pl-6 text-sm text-gray-500 dark:text-gray-400">
                                        <li>
                                            <NavLink to="/" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('sales')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/analytics" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('analytics')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/finance" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('finance')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/crypto" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('crypto')}</NavLink>
                                        </li>
                                    </ul>
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="apps">
                                <AccordionTrigger className="flex w-full items-center py-2 text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100">
                                    ...
                                    <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-gray-300 dark:group-hover:text-gray-100">{t('apps')}</span>
                                </AccordionTrigger>
                                <AccordionContent>
                                    <ul className="mt-1 space-y-1 pl-6 text-sm text-gray-500 dark:text-gray-400">
                                        <li>
                                            <NavLink to="/apps/chat" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('chat')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/apps/mailbox" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('mailbox')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/apps/todolist" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('todo_list')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/apps/notes" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('notes')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/apps/scrumboard" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('scrumboard')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/apps/contacts" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('contacts')}</NavLink>
                                        </li>
                                    </ul>
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="components">
                                <AccordionTrigger className="flex w-full items-center py-2 text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100">
                                    ...
                                    <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-gray-300 dark:group-hover:text-gray-100">{t('components')}</span>
                                </AccordionTrigger>
                                <AccordionContent>
                                    <ul className="mt-1 space-y-1 pl-6 text-sm text-gray-500 dark:text-gray-400">
                                        <li>
                                            <NavLink to="/components/buttons" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('buttons')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/forms" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('forms')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/components/tabs" className="block py-1 hover:text-gray-800 dark:hover:text-gray-200">{t('tabs')}</NavLink>
                                        </li>
                                    </ul>
                                </AccordionContent>
                            </AccordionItem>
