...
const Sidebar : React.FC = () => {
    ...
    return (
        <div className='dark'>
            <nav className={`sidebar fixed inset-y-0 z-50 h-full w-[260px] border-r shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300 border-gray-800 bg-gray-900 ${isSidebarOpen ? 'left-0' : '-left-[260px]'}`}>
                <div className="h-full">
                    <div className="flex items-center justify-between px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                    ...
                    <ScrollArea className="h-[calc(100vh-80px)] px-4 py-3">
                        <ul className="space-y-2">
                            <li>
                                <NavLink to="/" className="flex items-center py-2 text-gray-300 hover:text-gray-100">
                                    ...
                                    <span className="ltr:pl-3 rtl:pr-3 text-gray-300 group-hover:text-gray-100">{t('dashboard')}</span>
                                </NavLink>
                                <ul className="mt-1 space-y-1 pl-6 text-sm text-gray-400">
                                    <li>
                                        <NavLink to="/" className="block py-1 text-gray-400 hover:text-gray-200">{t('sales')}</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/analytics" className="block py-1 text-gray-400 hover:text-gray-200">{t('analytics')}</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/finance" className="block py-1 text-gray-400 hover:text-gray-200">{t('finance')}</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/crypto" className="block py-1 text-gray-400 hover:text-gray-200">{t('crypto')}</NavLink>
                                    </li>
                                </ul>
                            </li>
                            
                            <li>
                                <NavLink to="/dashboard/orders" className="flex items-center py-2 text-gray-300 hover:text-gray-100">
                                    <svg className="shrink-0 mr-2" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            opacity="0.5"
                                            d="M13 15.4C13 13.3258 13 12.2887 13.659 11.6444C14.318 11 15.3787 11 17.5 11C19.6213 11 20.682 11 21.341 11.6444C22 12.2887 22 13.3258 22 15.4V17.6C22 19.6742 22 20.7113 21.341 21.3556C20.682 22 19.6213 22 17.5 22C15.3787 22 14.318 22 13.659 21.3556C13 20.7113 13 19.6742 13 17.6V15.4Z"
                                    ...
                                    <span className="ltr:pl-3 rtl:pr-3 text-gray-300 group-hover:text-gray-100">{t('orders')}</span>
                                </NavLink>
                                {/* <ul className="mt-1 space-y-1 pl-6 text-sm text-gray-400">
                                    <li>
                            ...
                            <li>
                                <NavLink to="/components" className="flex items-center py-2 text-gray-300 hover:text-gray-100">
                                    <svg className="shrink-0 mr-2" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span className="ltr:pl-3 rtl:pr-3 text-gray-300 group-hover:text-gray-100">{t('components')}</span>
                                </NavLink>
                                <ul className="mt-1 space-y-1 pl-6 text-sm text-gray-400">
                                    <li>
                                        <NavLink to="/components/buttons" className="block py-1 hover:text-gray-200">{t('buttons')}</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/components/forms" className="block py-1 hover:text-gray-200">{t('forms')}</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/components/tabs" className="block py-1 hover:text-gray-200">{t('tabs')}</NavLink>
                                    </li>
                                </ul>
                            </li>
                        </ul>
